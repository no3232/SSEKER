...
import CardList from "../../component/UserCardList";
...
const index = () => {
  const skills: JSX.Element[] = test.map((item: StackElement) => (
    <StackIcon
      stack={item.title}
      key={item.id}
      clickable={false}
  ...
  return (
    <Container>
      ...
      <NanumSquareRegular />
      <NanumSquareBold />
      <DetailHeader name={"team"} mattermost={""} />
      <CampusBox>
      ...
      <DetailBox>
        ...
        <IntroBox>
          타입스크립트...너무 내 인생을 힘들게 한다 뭐 이런 고난과 시련이 다
          있냐 개씹스레기새끼...개쓰레기 언어...
        </IntroBox>
      </DetailBox>
    </Container>
